<?php
	class User extends CI_Model {
		...
		public function add_user($user) {
			$query = "INSERT INTO users(first_name,middle_name,last_name,email,password,created_at,updated_at,is_admin) 
			VALUES(?,?,?,?,?,?,?,?)";
			$values = array($user['first_name'],$user['middle_name'],$user['last_name'],$user['email'],password_hash($user['password'],
		...
		public function edit_user($user) {
			...
			$value = array($user['field_value'],date("Y-m-d H:i:s"),$user['id']);
