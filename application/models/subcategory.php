<?php
	class Subcategory extends CI_Model {
		public function get_all_subcategories() {
			return $this->db->query("SELECT * FROM subcategories")->result_array();
		}

		public function get_subcategory_id_by_slug($subcat_slug) {
			return $this->db->query("SELECT * FROM subcategories WHERE subcategory_slug=?",array($subcat_slug))->result_array();
		}
