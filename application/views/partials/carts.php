	...
	$cart_items = $this->session->userdata('list');
		for ($i = 0; $i < count($cart_items); $i++) { ?>
			<li class="item">
				...
				<div style="margin-bottom:1px;"><span class="pull-right">Qty: <?= $cart_items[$i]['qty']?> X <?=CURRENCY_SYMBOL.$cart_items[$i]['product_price']?></span></div>
...
<li class="pull-right" style="padding-top:6px;">Total: <?= CURRENCY_SYMBOL.$total_price?></li>
